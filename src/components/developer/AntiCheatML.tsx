  ...
  return (
    <div className="rounded-xl border border-separator bg-card p-6">
      ...
      <div className="bg-input rounded-lg border border-separator p-4 flex items-center justify-between">
        ...
        <button className="text-[11px] font-bold bg-red text-white px-3 py-1.5 rounded-md hover:bg-red/80 transition-colors flex items-center gap-1">
          <Crosshair className="h-3 w-3" /> Train Model
        </button>
      </div>
    </div>
  );
