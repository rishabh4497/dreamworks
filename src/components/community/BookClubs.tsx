  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-purple-500/30 bg-card p-8 mt-8">
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center">
        <img loading="lazy" decoding="async" src="https://images.igdb.com/igdb/image/upload/t_cover_big/co67w0.jpg" alt="Celeste" className="w-48 rounded-xl shadow-2xl border border-separator rotate-[-2deg]" />
