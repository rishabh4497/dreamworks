    ...
    >
      ...
      <aside className="space-y-4">
        <div className="rounded-2xl border border-separator bg-card overflow-hidden">
          <img loading="lazy" decoding="async" src={detail.headerUrl} alt="" className="aspect-[460/215] w-full object-cover" referrerPolicy="no-referrer" />
...
function ReviewCard({ review: r, isYours }: { review: Review; isYours?: boolean }) {
  return (
    ...
    >
      ...
      <div className="mb-2 flex items-center gap-2">
        <img loading="lazy" decoding="async" src={r.authorAvatarUrl} alt="" className="h-7 w-7 rounded-full object-cover" />
